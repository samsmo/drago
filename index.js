...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coreDecorators = __webpack_require__(1);
	...
	var Drago = (_class = function () {
	  function Drago(el, container, options) {
	    _classCallCheck(this, Drago);
	  ...
	  _createClass(Drago, [{
	    ...
	    value: function _init() {
	      ...
	      setTimeout(function () {
	        _this._el_rect = _this._el.getBoundingClientRect();
	        _this._container_rect = _this._container.getBoundingClientRect();
	      }, 0);
	      this._loop();
	    }
	  }, {
	    ...
	    value: function _handleDrag(e) {
	      if (this._isMoving) {
	        var clientX = e.clientX ? e.clientX : e.changedTouches[0].clientX;
	        var clientY = e.clientY ? e.clientY : e.changedTouches[0].clientY;
	        if (!this._startPos) {
	          var rect = this._el.getBoundingClientRect();
	          var x = clientX - rect.left;
	          var y = clientY - rect.top;
	          this._startOffset = { x: x, y: y };
	    ...
	    value: function _stopDrag(e) {
	      ...
	      var time = (this._draggedTime - this._startTime) / 15;
	      var xDistance = clientX - this._startPos.x;
	      var yDistance = clientY - this._startPos.y;
	    ...
	    key: '_killDrag',
	    value: function _killDrag() {
	      this._isMoving = false;
	    }
	  }, {
	    key: 'bound',
	    value: function bound(coord, boundMax, boundMin) {
	      var value = coord;
	      if (coord >= boundMax) {
	        value = boundMax;
	    ...
	    value: function checkBounds() {
	      var width = this._el_rect.width;
	      var height = this._el_rect.height;
	      var test = void 0;

	      if (this._opts.axis.x && this._opts.bounds.x) {
	        if (this._opts.restrict === 'contain') {
	          var rightBound = this._container_rect.width - width;
	          var leftBound = this._container_rect.left;

	          test = this.bound(this._loc.x, rightBound, leftBound);
	        } else if (this._opts.restrict.x === 'opposite') {
	          var left = this._container_rect.left - width * .75;
	          var right = this._container_rect.width - width * .25;
	      ...
	      if (this._opts.axis.y && this._opts.bounds.y) {
	        if (this._opts.restrict === 'contain') {
	          var top = this._container_rect.top;
	          var bottom = this._container_rect.height - height;

	          test = this.bound(this._loc.y, bottom, top);
	        } else if (this._opts.restrict === 'opposite') {
	          var _top = this._container_rect.top - height * .75;
	          var _bottom = this._container_rect.height - height * .25;

	          test = this.bound(this._loc.y, _bottom, _top);
	        }
	  ...
	  return Drago;
	}(), (_applyDecoratedDescriptor(_class.prototype, '_startDrag', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, '_startDrag'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, '_handleDrag', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, '_handleDrag'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, '_stopDrag', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, '_stopDrag'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, '_killDrag', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, '_killDrag'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'bound', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, 'bound'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'checkBounds', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, 'checkBounds'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, '_loop', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, '_loop'), _class.prototype)), _class);
	exports.default = Drago;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autobind = __webpack_require__(8);

	exports.autobind = _interopRequire(_autobind);

	var _readonly = __webpack_require__(9);
	...
	var _nonenumerable = __webpack_require__(11);

	exports.nonenumerable = _interopRequire(_nonenumerable);

	var _nonconfigurable = __webpack_require__(12);
	...
	var _decorate = __webpack_require__(15);
	...
	var _extendDescriptor = __webpack_require__(18);
	...
	var _applyDecorators = __webpack_require__(19);
